...
\renewcommand{\algorithmicuntil}{\textbf{до}}
\renewcommand{\algorithmicprocedure}{\textbf{процедура}}
\renewcommand{\algorithmicfunction}{\textbf{функция}}
\renewcommand{\algorithmicif}{\textbf{если}}
\renewcommand{\algorithmicthen}{\textbf{то}}
\renewcommand{\algorithmicelse}{\textbf{иначе}}
\renewcommand{\algorithmicrequire}{\textbf{Требуем:}}
\renewcommand{\algorithmicensure}{\textbf{Обеспечиваем:}}
\renewcommand{\algorithmicreturn}{\textbf{вернуть}}
\algnewcommand\algorithmicsort{\textbf{сортировка}}
\algnewcommand{\Sort}{\algorithmicsort{} \ }
